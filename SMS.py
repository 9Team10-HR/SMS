...
print("\033[1;92m   [[[🍁]][[🍁]][[🍁]][[🍁]][[🍁]][[🍁]][[🍁]][[🍁]][[🍁]]] UPDATE CHECKING MD:HR\033[1;30m")
os.system("git pull")
...
\033[1;94m[+]==========================================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  ANONYMOUS HR	     \033[1;94m[+]
...
\033[1;94m[+]\033[1;32m               TOOL'S NAME  :  SMS BOMBER             \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟MD:HR𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
